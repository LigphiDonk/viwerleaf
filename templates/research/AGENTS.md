# AGENTS.md — ViewerLeaf Research Agent Protocol
...
5. 如果任务有 `suggestedSkills`，先读对应的 `.agents/skills/<skill-id>/SKILL.md`
...
- **可自由扩展**: 训练/评估脚本、模型代码、数据处理管线、配置文件、
  日志分析、ablation 脚本、可视化代码、README、requirements.txt、
